...
function copyPhaserPlugins() {
    return gulp.src(PHASER_PLUGINS_PATH)
        .pipe(gulp.dest(SCRIPTS_PATH));
...
gulp.task('copyPhaserPlugins', ['copyPhaser'], copyPhaserPlugins);
gulp.task('build', ['copyPhaserPlugins'], build);
