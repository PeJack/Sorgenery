class Credits extends Phaser.State {
  ...
  create() {
    let bg = this.game.add.sprite(0, 0, 'menu4');
  ...
  createButton(text, callback) {
    let button = this.game.add.button(90, (this.optionCount * 80), 'button', callback, this, 2, 1, 0);
  ...
  addCredit(task, author) {
    ...
    let authorText = this.game.add.text(this.game.world.centerX, 900, author, authorStyle);
    let taskText = this.game.add.text(this.game.world.centerX, 950, task, taskStyle);
